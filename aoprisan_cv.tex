...
\ecvitem{\small\textsc{{\color{light-gray}Skills and experience}}}{
  Andrei has 14 years of experience in software industry and academia, acting as product manager, software developer, 
  architect and researcher, with almost 5 years in the data security field and 5 years writing 
  ...
  In the last several years Andrei has been consulting companies and startups on software development services, with the last year focused 
  on Business Intelligence solutions for energy management. 
}
...
\ecvitem{\small\textsc{{\color{light-gray}Occupation or position held}}}{\textbf{Senior Scala Software Engineer}}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Dates}}}{April 2015--Present Time}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Name and address of employer}}}{Eloquentix Ltd, Chapel Hill, North Carolina, United States}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Type of business or sector}}}{Scala Software Development}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Main activities and responsibilities}}}{- Software design and development using agile techniques, functional and object-oriented programming of distributed micro-services}\nopagebreak
\ecvitem{}{ - Database REST access services}\nopagebreak
\ecvitem{}{ - Working with remote teams}\nopagebreak
\ecvitem{}{ - Test Driven Development}
\ecvitem[20pt]{}{ - Development primarily with Scala, Java, Play 2.x, Docker, Postgresql, Hibernate}

\ecvitem{\small\textsc{{\color{light-gray}Occupation or position held}}}{\textbf{Senior Software Engineer}}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Dates}}}{April 2014--Present Time}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Name and address of employer}}}{WEBfactory GmbH, Buchen, Germany}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Type of business or sector}}}{Software Development of Business Intelligence Systems}\nopagebreak
\ecvitem{\small\textsc{{\color{light-gray}Main activities and responsibilities}}}{- Software design and development using agile techniques, object-oriented programming}\nopagebreak
\ecvitem{}{ - Front-end architecture and development}\nopagebreak
\ecvitem{}{ - Reports design and development}\nopagebreak
\ecvitem{}{ - Automation of deployment routines}\nopagebreak
\ecvitem{}{ - OLAP cubes configuration and data import services}
\ecvitem[20pt]{}{ - Development primarily with C\#, F\#, Javascript, Typescript, Durandal, Knockout, Underscore, Asp.Net MVC and Web API, .Net Reactive Extensions, Microsoft SQL Server, Analysis Services and Reporting Services}
